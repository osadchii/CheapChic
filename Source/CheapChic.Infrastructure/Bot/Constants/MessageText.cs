...
public static class MessageText
{
    public static class Management
    {
        ...
        {
            public const string SendToken =
                "Отправьте токен вашего бота. Для получения токена вашего бота воспользуйтесь официальным Телеграм-ботом @BotFather";
            ...
            public const string SuccessfulAdded =
                "Бот успешно добавлен. Теперь добавьте бот на канал для публикации объявлений и сделайте его администратором";
        ...
        public static class MyBots
        {
            ...
            public const string SendPublishDays =
                "Пришлите количество дней, через которое объявление будет автоматически деактивировано (не более 28 дней)";

            public const string SendPublishEveryHours =
                "Пришлите количество часов, через которое объявление будет отправлено повторно (не менее 1 часа)";
    ...
    public static class Retailer
    {
        ...
        public static class MainManu
        {
            public const string SetUsername =
                "Прежде чем добавлять объявления, задайте имя пользователя (Username) в настройках телеграм. Это нужно, чтобы другие пользователи могли написать вам";
        }
        ...
        public static class AddAd
        {
            ...
            public const string SendPhoto =
                "Пришлите фотографии для вашего объявления (до 4 фотографий) и нажмите \"Готово\"";
